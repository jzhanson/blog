...
Note that because the denominator is constant with respect to theta and the sampled data *x<sub>1</ub>, ..., x<sub>n</sub>*, and the numerator is equal to the joint probability
